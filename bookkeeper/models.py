...
class Project(models.Model, ProjectBase):
    ...
    bookset = models.ForeignKey(BookSet, related_name="projects", on_delete=models.CASCADE,
...
class Account(models.Model, _AccountApi):
    ...
    bookset = models.ForeignKey(BookSet, on_delete=models.CASCADE, db_column='org', related_name='account_objects')
...
class ThirdParty(models.Model):
    ...
    account = models.ForeignKey(Account, related_name="third_parties", on_delete=models.CASCADE,
...
class AccountEntry(models.Model):
    ...
    transaction = models.ForeignKey(Transaction, on_delete=models.CASCADE, db_column='tid', related_name='entries')

    account = models.ForeignKey(Account, on_delete=models.CASCADE, db_column='accid', related_name='entries')
    ...
    third_party = models.ForeignKey(ThirdParty, on_delete=models.CASCADE, related_name='account_entries', null=True)
